    ...
    function build(opts) {
        ...
        svg.Element.ElementBase = function(node) {
            ...
            if (node != null && node.nodeType == 1) { //ELEMENT_NODE
                ...
                // add inline styles
            if (this.attribute('style').hasValue()) { //获取到节点的颜色
        ...
        svg.Element.svg = function(node) {
            ...
            this.setContext = function(ctx) {
                ...
                ctx.lineCap2 = 'butt';  //向线条的每个末端添加平直的边缘。
                ctx.lineJoin2 = 'miter'; //创建尖角。
                ctx.miterLimit2 = 4; //只有当 lineJoin 属性为 "miter" 时，miterLimit 才有效。边角的角度越小，斜接长度就会越大。
                ...
                ctx.translate2(this.attribute('x').toPixels('x'), this.attribute('y').toPixels('y'));////把当前画布的原点移到(这个坐标点),后面的操作都以(这个坐标点)作为参照点，  0,0
                ...
                if (typeof(this.root)== 'undefined') {   //修改，原来是等于
        ...
        svg.Element.rect = function(node) {
            ...
            this.path = function(ctx) {
                ...
                console.log(x,y,rx,ry,width,height)
        ...
        svg.Element.line = function(node) {
            ...
            this.path = function(ctx) {
                ...
                if (ctx != null) {
                    ctx.fillStyle ='#6ac6ff';//填充颜色：红色，半透明
                    ctx.strokeStyle ='#6ac6ff';//线条颜色：绿色
